"""
Weather Satellite RFI Modeling Tutorial - "Looking Down" Case (Phase 2)
...
- 5G ground emitter modeling and distribution
- Ground emitter link budget with atmospheric loss
- Terrain masking/horizon visibility checks
...
# For testing harmonic, use 11.9 GHz and its 2nd harmonic is in the range of K-band
# starlink_freq = 11.325e9  # Hz (same as tuto_radiomdl_environment.py)
starlink_freq = 11.9e9  # Hz (for testing harmonic)
...
# # =============================================================================
# # SCENARIO A: SUBURBAN (Mid-Band 5G) - DEFAULT, ACTIVE
# # =============================================================================
# # Frequencies
...
# =============================================================================
# SCENARIO B: URBAN (High-Band/mmWave 5G) - COMMENTED OUT
# =============================================================================
# Frequencies
...
print("Step 7: Modeling weather satellite observations (Phase 2)...")
...
for f_idx, freq in enumerate(freq_channels):
    ...
    # Model observed power using Phase 2 function (includes ground emitters)
    result_dict = model_weather_sat_observed_power_phase2(
...
# Plot 2: Breakdown of RFI components by frequency (Phase 2: includes ground emitters)
